...
# ===========================================================================
# Build targets only - this includes libgizmo, arch specific targets, clean
...
# Defaults to libgizmo, but the arch makefile usually adds further targets
all: libgizmo 
...
libgizmo-dirs	:= $(objs-y) $(libs-y)
libgizmo-objs	:= $(patsubst %,%/built-in.o, $(objs-y))
libgizmo-libs	:= $(patsubst %,%/lib.a, $(libs-y))
libgizmo-header	:= include/gizmo.h
...
libgizmo: $(libgizmo-all) $(libgizmo-header) FORCE
	+$(call if_changed,libgizmo)


$(libgizmo-header): FORCE
	@$(MAKE) -C include

# The actual objects are generated when descending,
# make sure no implicit rule kicks in
$(sort $(libgizmo-all)): $(libgizmo-dirs) ;

# Handle descending into subdirectories listed in $(libgizmo-dirs)
...
CLEAN_DIRS  +=
CLEAN_FILES +=	libgizmo.so include/gizmo.h
...
clean-dirs      := $(addprefix _clean_, . $(libgizmo-dirs))
...
help:
	...
	@echo  '* libgizmo		  - Build the library'
